...
SRC_URI_append = " \
	...
	file://patch_vdr_240/vdr-2.4.0-01-fix-svdrp-modt-recflag.patch \
        file://patch_vdr_240/vdr-2.4.0-02-fix-invalid-locking-sequence.patch \
        file://patch_vdr_240/vdr-2.4.0-03-fix-locking-channel-display.patch \
        file://patch_vdr_240/vdr-2.4.0-04-fix-locking-channel-display-2.patch \
        file://patch_vdr_240/vdr-2.4.0-05-fix-shutdown.patch \
        file://patch_vdr_240/vdr-2.4.0-06-fix-channel-switch.patch \
        file://patch_vdr_240/vdr-2.4.0-07-fix-disabling-mtd.patch \
        file://patch_vdr_240/vdr-2.4.0-08-add-multi-frontend-support.patch \
    file://0_jpeg.patch \
    file://runvdr \	
