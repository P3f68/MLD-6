    ...
    /meta-mld-souce                         ( Die MLD Sourcen )
        ...
        /meta-system
            ...
            /recipes-core                   ( Basis Pakete der MLD)
                ...
                /exlinux
                /image                      ( 
                                              enthaelt die zusammenstellungen der verschiedene Images(builds) 
                                              image-rpi.bb (raspberrypi)
                                              image-x86.bb (i386, amd64)
                                            )  
                /init
                /install
                /network
            ...
            /recipes-tools                  ( Alle zusätzlichen Tools, z.B.: shelinabox)    
